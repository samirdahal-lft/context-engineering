...
class Settings(BaseSettings):
    ...
    naive_overflow_shrink_factor: float = 0.8   # multiply word cap by this on each overflow retry
    naive_overflow_min_words: int = 1_000        # stop shrinking below this word count
    ...
    # tokens + the summary without hitting MaxTokensReachedException.
    subagent_summary_tokens: int = 1200
    # The orchestrator's FINAL turn weaves all 3 specialist summaries into one
    # structured comparison -- the longest single output in the app. Give it ample
